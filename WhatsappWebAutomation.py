...
def start_menu():
    ...
    frm.grid()
    ttk.Button(frm, text="New QR Code", command=scan_new_qr).grid(column=0, row=0, pady=10)
    ttk.Button(frm, text="Continue", command=use_old_qr).grid(column=0, row=1, pady=10)
